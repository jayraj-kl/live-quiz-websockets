...
export const UserLoggedin = ({name, code}) => {
    ...
    useEffect(() => {
        console.log("Updated total question:", totalQuestions);
    }, [totalQuestions]); // This will run every time totalQuestions is updated
    ...
    if (currentState === "question") {
        return <div>
            <p>Question {currentProblemIndex} of {totalQuestions}</p>
